  ...
  ingredients: [
    {
      ...
      img: images.ing.soyPaper,
      id: 80857,
      bg: '#ff9efc',
    },
    {
      name: ['ogórek', 'kappa'],
      img: images.ing.cucumber,
      id: 34811,
      bg: '#458228',
    },
    {
      name: ['oshinko', 'rzepa', 'rzepa marynowana'],
      img: images.ing.radish,
      id: 41324,
      bg: '#fff830',
    },
    {
      name: ['kanpyo', 'tykwa', 'tykwa marynowana'],
      img: images.ing.gourd,
      id: 11942,
      bg: '#522f03',
    },
    {
      name: ['awokado', 'avocado'],
      img: images.ing.avocado,
      id: 37177,
      bg: '#18522e',
    },
    {
      name: ['mango'],
      img: images.ing.mango,
      id: 17771,
      bg: '#e8d01e',
    },
    {
      name: ['jalapeño',],
      img: images.ing.jalapeno,
      id: 19009,
      bg: '#1c5218'
    },
    {
      name: ['shiitake'],
      img: images.ing.shiitake,
      id: 84048,
      bg: '#6e3f05',
    },
    {
    ...
    },
    {
      ...
      img: images.ing.pancake,
      id: 38118,
      bg: '#edbf5a',
    },
    {
      name: ['sałata', 'lettuce'],
      img: images.ing.lettuce,
      id: 81142,
      bg: '#7ec940',
    },
    {
    ...
    },
    {
      ...
      img: images.ing.coriander,
      id: 68411,
      bg: '#1b7025',
    },
    {
      name: ['dymka', 'cebula zielona'],
      img: images.ing.greenOnion,
      id: 92900,
      bg: '#1f7029',
    },
    {
      name: ['migdały', 'almond', 'migdały grillowane'],
      img: images.ing.almond,
      id: 85074,
      bg: '#f2d679',
    },
    {
      name: ['pistacje', 'pistachios'],
      img: images.ing.pistachios,
      id: 48991,
      bg: '#7fa35f',
    },
    {
      name: ['sezam', 'sesame'],
      img: images.ing.sesame,
      id: 40099,
      bg: '#fcde83',
    },
    {
      name: ['orzeszki ziemne', 'peanuts'],
      img: images.ing.peanut,
      id: 81172,
      bg: '#c29c4a',
    },
    {
      name: ['togarashi',],
      img: images.ing.togarashi,
      id: 77177,
      bg: '#8f330b',
    },
    ...
    {
      name: ['panko'],
      img: images.ing.panko,
      id: 49142,
      bg: '#e8d78b',
    },
    {
      name: ['tempura'],
      img: images.ing.tempura,
      id: 53807,
      bg: '#e8d78b',
    },
    ...
    {
      name: ['okóń morski', 'seabass', 'labraks'],
      img: images.ing.seabass,
      id: 39592,
      bg: '#e3d4d3',
    },
    {
      name: ['butter fish', 'ryba maślana'],
      img: images.ing.butterfish,
      id: 17455,
      bg: '#fff9e6',
    },
    {
      name: ['zander', 'sandacz'],
      img: images.ing.zander,
      id: 72397,
      bg: '#d6d6d6',
    },
    {
      name: ['seriola', 'amberjack'],
      img: images.ing.amberjack,
      id: 52438,
      bg: '#ffe7de',
    },
    {
      name: ['halibut'],
      img: images.ing.halibut,
      id: 19451,
      bg: '#fff9f2',
    },
    {
      name: ['octopus', 'ośmiornica'],
      img: images.ing.octopus,
      id: 52144,
      bg: '#8c560e',
    },
    {
    ...
    },
    {
      ...
      img: images.ing.shrimp,
      id: 10568,
      bg: '#ffca8a',
    },
    {
      name: ['rainbow', '3 różne ryby', 'sal/tun/ter'],
      img: images.ing.rainbow,
      id: 71717,
      bg: '#7d2863',
    },
    {
    ...
    },
    {
      ...
      img: images.ing.friedVeg,
      id: 13245,
      bg: '#7fba61',
    },
    {
      name: ['chrupki, chrupki z tempury',],
      img: images.ing.crumbs,
      id: 85122,
      bg: '#7fba61',
    },
    {
      name: ['asparagus tempura', 'szparag w tempurze'],
      img: images.ing.friedAsparagus,
      id: 54326,
      bg: '#a6a63f',
    },
    {
      name: ['cukinia w panko', 'zucchini panko'],
      img: images.ing.friedZucchini,
      id: 18003,
      bg: '#74873e',
    },
    {
      name: ['grilled eggplant', 'bakłażan grillowany'],
      img: images.ing.friedEggplant,
      id: 18055,
      bg: '#635325',
    },
    {
      name: ['banana tempura', 'banan w tempurze'],
      img: images.ing.friedBanana,
      id: 81099,
      bg: '#ede76f',
    },
    {
      name: ['nutella'],
      img: images.ing.nutella,
      id: 10012,
      bg: '#403000',
    },
    {
      name: ['strawberry', 'truskawka', 'trueskawka'],
      img: images.ing.strawberry,
      id: 18991,
      bg: '#ba2323',
    },
    {
      name: ['bita śmietana', 'whipped cream'],
      img: images.ing.cream,
      id: 99199,
      bg: '#fff2f2',
    },

    {
      ...
      img: images.ing.surimi,
      id: 74113,
      bg: '#d46c6c',
    },
    {
      name: ['tatar z łososia', 'salmon tartar'],
      img: images.ing.salmonTartare,
      id: 81740,
      bg: '#b54a35',
    },
    {
...

    {
      ...
      img: images.ing.masagoArare,
      id: 19951,
      bg: '#ffe4bd',
    },
    {
      name: ['tosago', 'vege caviar', 'kawior wegetariański'],
      img: images.ing.caviar,
      id: 10001,
      bg: '#e68675',
    },
    {
